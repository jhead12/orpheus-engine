...
export const SidePanelConfig: VisualTestConfig = {
  ...
  states: [
    ...
    },
    {
      name: 'single-file',
      props: {
        audioFiles: [{ id: '1', name: 'Single Track.wav', duration: 300 }],
        collapsed: false,
      },
    },
    {
      ...
      props: {
        audioFiles: [
          {
            id: '1',
            name: 'Very Long Filename That Should Be Truncated.wav',
            duration: 180,
          },
          {
            id: '2',
            name: 'Another Extremely Long Audio File Name.wav',
            duration: 240,
          },
        ],
        collapsed: false,
  ...
  containerStyle:
    'width: 400px; height: 600px; background: #1e1e1e; position: relative;',
