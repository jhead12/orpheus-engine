...
export const RouterContext = {
  Provider: ({ children }: RouterProps) => React.createElement(React.Fragment, null, children),
  Consumer: ({ children }: any) => React.createElement(React.Fragment, null, children(mockRouterContext))
};
