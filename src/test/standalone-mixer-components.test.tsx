...
import {
  ...
  hasChildWithClass,
} from './utils/mixer-test-bailout-utils';
...
const KnobComponent = () => (
  <input data-testid="knob" type="range" min="-100" max="100" title="Pan: 0" />
);
...
describe('Mixer Component Core DOM Tests', () => {
  describe('Peak Display Tests', () => {
    ...
    it('should add peak display to specific meter', () => {
      ...
      expect(hasChildWithClass(meter as HTMLElement, 'peak-display')).toBe(
        false
      );
