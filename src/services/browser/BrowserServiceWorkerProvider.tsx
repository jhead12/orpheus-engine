...
export const BrowserServiceWorkerProvider: React.FC<
  BrowserServiceWorkerProviderProps
> = ({ children }) => {
...
export const useServiceWorker = (): ServiceWorkerContextType => {
  ...
  if (!context) {
    throw new Error(
      'useServiceWorker must be used within a BrowserServiceWorkerProvider',
    );
  }
  return context;
};
