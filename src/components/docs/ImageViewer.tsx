...
export const ImageViewer: React.FC<ImageViewerProps> = ({
  ...
  const filteredImages = images.filter((image) => {
    ...
    const matchesSearch =
      ...
      (image.component &&
        image.component.toLowerCase().includes(searchTerm.toLowerCase()));
            ...
            <div className="image-grid">
              {componentImages.map((image) => (
                <div key={image.path} className="image-card">
                  ...
                  >
                    <img src={image.path} alt={image.testName} loading="lazy" />
        ...
        <div className="image-modal" onClick={closeModal}>
          ...
          >
            ...
            <div className="modal-info">
              <h3>
                {selectedImage.component} - {selectedImage.testName}
              </h3>
