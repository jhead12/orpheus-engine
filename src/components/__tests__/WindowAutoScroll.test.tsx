...
describe('WindowAutoScroll Component', () => {
  ...
  test('should not attach event listeners when not active', () => {
    ...
    render(<WindowAutoScroll {...defaultProps} active={false} />);
  ...
  test('should attach dragover event listener when active and eventType is "drag"', () => {
    ...
    render(
      <WindowAutoScroll {...defaultProps} active={true} eventType="drag" />,
    );
  ...
  test('should attach mousemove event listener when active and eventType is not "drag"', () => {
    ...
    render(
      <WindowAutoScroll {...defaultProps} active={true} eventType="mouse" />,
    );
  ...
  test('should call onScroll callback when scrolling occurs', () => {
    ...
    Object.defineProperty(mockScrollableElement, 'scrollLeft', {
      value: 50,
      writable: true,
    });
    ...
    render(<WindowAutoScroll {...defaultProps} onScroll={onScrollMock} />);
