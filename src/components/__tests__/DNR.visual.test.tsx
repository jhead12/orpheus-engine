...
describe('DNR Visual Tests', () => {
  ...
  it('renders DNR in default state @visual', async () => {
    ...
    try {
      ...
      render(
        <DNR coords={coords} drag={false} dragAxis="both" resize={false}>
          <div
            style={{
              width: '100%',
              height: '100%',
  ...
  it('renders DNR during resize @visual', async () => {
    ...
    try {
      ...
      render(
        <DNR coords={coords} drag={false} dragAxis="both" resize={true}>
          <div
            style={{
              width: '100%',
              height: '100%',
  ...
  it('renders DNR during drag @visual', async () => {
    ...
    try {
      ...
      render(
        <DNR coords={coords} drag={true} dragAxis="both" resize={true}>
          <div
            style={{
              width: '100%',
              height: '100%',
