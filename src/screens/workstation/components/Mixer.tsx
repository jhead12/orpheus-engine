    ...
    return (
      ...
      >
        <div className="d-flex flex-column" style={{ flex: 1, height: "100%" }}>
          <div
            className={
              "d-flex flex-column col-12 overflow-hidden" +
              (selected ? " overlay-1" : "")
            }
            style={{
              flex: 1,
          ...
          >
            ...
            >
              <div
                ...
                style={{ marginLeft: 6, padding: "9px 0 10px" }}
              >
                <div className="d-flex" style={{ height: "100%" }}>
                  <Meter
                    ...
                    marks={[
                      {
                        value: 75,
                        style: { backgroundColor: "var(--border12)" },
                      },
                    ]}
                ...
                >
                  ...
                  <div>
                    <div title={muteButtonTitle}>
                      <button
                        className={`track-btn stop-reorder ${
          ...
          {isMaster ? (
            <p
              className="center-flex col-12 m-0 font-bold"
            ...
            <div className="col-12 m-0 p-0" style={style.trackTextContainer}>
              ...
              <div
                className="col-12 overflow-hidden m-0 center-flex"
...
function Mixer() {
  ...
  function getListItemClass(idx: number) {
    ...
    else if (edgeIndex === idx + 1) return "position-relative sort-indicator-v";
  ...
  return (
    ...
    >
      ...
      >
        {tracks.map((t, idx) => (
          <SortableListItem
            className={getListItemClass(idx)}
            key={t.id}
            index={idx}
          >
