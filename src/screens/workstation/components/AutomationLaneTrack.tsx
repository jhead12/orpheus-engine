...
export default function AutomationLaneTrack({ color, lane, track }: Props) {
  ...
  const newNodePosTextValid =
    nodeText.pos === '' ||
    (posFromNewNodePosText &&
      posFromNewNodePosText.compareTo(TimelinePosition.start) >= 0);
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (newNodePosTextValid && newNodeValueTextValid) {
      ...
      else pos = posFromNewNodePosText;
  ...
  const automatedValueAtPos = (
    ...
    if (beforeNode && afterNode) {
      ...
      return (
        ...
        (afterNode.value.value - beforeNode.value.value) * ratio
      );
    }
    ...
    <div onContextMenu={handleContextMenu} style={{ width: '100%' }}>
      ...
      >
        ...
        >
          <IconButton
            ...
            onClick={() =>
              setLane(track, { ...lane, expanded: !lane.expanded })
            }
            style={{
      ...
      {lane.expanded && (
        <div
          ...
          style={{
            height: BASE_HEIGHT * verticalScale - 22,
        ...
        >
          ...
          <div
            ...
            style={{
              width: 43,
              height: '100%',
              borderLeft: '1px solid var(--border4)',
            }}
          >
            <IconButton
            ...
            >
              ...
              >
                <input
                  ...
                  onChange={(e) =>
                    setNodeText({ ...nodeText, pos: e.target.value })
                  }
                  placeholder="X.X.XXX"
                  style={
                    !newNodePosTextValid
                      ? { borderColor: '#f00', color: '#f00' }
                      : {}
                  }
                  value={nodeText.pos}
                />
                <input
                  className="text-center mb-1 d-block input1"
                  onChange={(e) =>
                    setNodeText({ ...nodeText, value: e.target.value })
                  }
                  placeholder="Value"
                  style={
                    !newNodeValueTextValid
                      ? { borderColor: '#f00', color: '#f00' }
                      : {}
                  }
                ...
                />
                <input
                  className="py-1 col-12 d-block btn-3"
                  type="submit"
                  value="Add"
                />
              </form>
