...
describe('ProjectFileService - File Operations', () => {
  ...
  test('should save a project to a JSON file', async () => {
    ...
    expect(vi.mocked(require('../../services/electron/utils').electronAPI.writeFile)).toHaveBeenCalled();
  });
  ...
  test('should load a project from a JSON file', async () => {
    ...
    expect(vi.mocked(require('../../services/electron/utils').electronAPI.readFile)).toHaveBeenCalled();
  });
  ...
  test('should import audio file metadata', async () => {
    ...
    vi.mocked(require('../../services/electron/utils').electronAPI.showOpenDialog)
    ...
    expect(vi.mocked(require('../../services/electron/utils').electronAPI.showOpenDialog)).toHaveBeenCalled();
  });
  ...
  test('should handle export cancellation by user', async () => {
    ...
    vi.mocked(require('../../services/electron/utils').electronAPI.showSaveDialog)
