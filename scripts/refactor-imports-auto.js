#!/usr/bin/env node
/**
 * Refactor Imports Auto - Automatically refactors deep relative imports to use path aliases
 *
 ...
 *
 * This version applies all changes automatically without asking for confirmation
 */
